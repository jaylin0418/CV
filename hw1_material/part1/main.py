...
def main():
    ...
    ### TODO ###
    key_points = Difference_of_Gaussian(args.threshold).get_keypoints(img)
    plot_keypoints(img, key_points, './output.png')
    print('Output image has been saved to ./output.png')
